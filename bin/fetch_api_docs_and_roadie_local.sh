...
# Download Roadie Local CLI binaries
VERSION="v0.1.1"
DEST_DIR="static/downloads/roadie-local/v0.0.1"
BASE_URL="https://github.com/RoadieHQ/roadie-local/releases/download/cli-${VERSION}"
