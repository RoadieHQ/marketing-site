      ...
      <section className='Section size-3'>
        <div className='Grid columns-2 gap-6'>
          ...
          <div>
            ...
            <p className='Text size-4' style={{ marginBottom: '20px'}}>I encourage my team to keep learning. Ideas in different topics or fields can often inspire new ideas and broaden the potential solution space. I encourage my team to keep learning. Ideas in different topics or fields can often inspire new ideas and broaden the potential solution.<sup className='Sup'>1</sup></p>
          </div>
          <div>
