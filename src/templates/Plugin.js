      ...
      {!isEmpty(installHtml) && (
        <>
          <div className="mb-4" id="installation-steps">
            <Title className="text-3xl">Installation steps</Title>
          </div>
      ...
      {!isEmpty(changelog) && (
        <>
          ...
          <div className="prose prose-primary max-w-none mb-4">
            <p>This changelog is produced from commits made to the {humanName} plugin since{' '}
              {changelogSince} (based on the code located <Link to={codeLocation} color="primary">here</Link>.
               It may not contain information about all commits. Releases and version bumps
               are intentionally omitted. This section is generated by AI.
            </p>
          </div>
          <div
            className="prose prose-primary max-w-none"
