...
const CurrencySwitcherButton = ({ currentlySetCurrency, setCurrency, currency }) => {
  const sharedClassNames = 'relative w-1/2 rounded-md py-2 text-sm font-medium whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-primary-600 focus:z-10 sm:w-auto sm:px-8';
